...
from yolo_predictions_license_plate import YOLO_Pred
...
st.header('Get License PLate Detection for any car Image')
        ...
        with col2:
            ...
            if button:
                ...
                Geting Objets from image. please wait
                    ...
                    pred_img , text_list= yolo.predictions(image_array)
